...
void main() {
  group('HierarchicalIdentifier', () {
    test('should parse and format a string correctly', () {
      final id = HierarchicalIdentifier.fromString('001:002:003');
      expect(id.idAsString(), '001:002:003');
    });

    test('should recognize a parent-child relationship', () {
      final parent = HierarchicalIdentifier.fromString('001:002');
      final child = HierarchicalIdentifier.fromString('001:002:003');
    ...
    test('should recognize a sibling relationship', () {
      final sibling1 = HierarchicalIdentifier.fromString('001:002:003');
      final sibling2 = HierarchicalIdentifier.fromString('001:002:004');
      final nonSibling = HierarchicalIdentifier.fromString('001:003:003');
    ...
    test('should recognize an equal relationship', () {
      final id1 = HierarchicalIdentifier.fromString('001:002:003');
      final id2 = HierarchicalIdentifier.fromString('001:002:003');
      final id3 = HierarchicalIdentifier.fromString('001:002:004');
      expect(id1, id2);
      expect(id2, id1);
